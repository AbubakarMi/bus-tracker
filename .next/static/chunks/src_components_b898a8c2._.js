...
const FeatureCard = ({ feature, index })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
;
;
function Typewriter({ text, speed = 100, delay = 0, loop = false, className, ...props }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Typewriter.useEffect": ()=>{
            ...
            const handleTyping = {
                "Typewriter.useEffect.handleTyping": ()=>{
                    ...
                    if (isDeleting) {
                        if (i > 0) {
                            setDisplayedText({
                                "Typewriter.useEffect.handleTyping": (prev)=>prev.substring(0, prev.length - 1)
                            }["Typewriter.useEffect.handleTyping"]);
                            timeoutId = setTimeout(handleTyping, speed / 2);
                        } else {
                            setIsDeleting(false);
                            setCurrentTextIndex({
                                "Typewriter.useEffect.handleTyping": (prev)=>(prev + 1) % textArray.length
                            }["Typewriter.useEffect.handleTyping"]);
                        }
                    } else {
                        if (i < currentText.length) {
                            setDisplayedText({
                                "Typewriter.useEffect.handleTyping": (prev)=>prev + currentText.charAt(i)
                            }["Typewriter.useEffect.handleTyping"]);
                            ...
                            if (currentTextIndex < textArray.length - 1) {
                                ...
                                timeoutId = setTimeout({
                                    "Typewriter.useEffect.handleTyping": ()=>{
                                        setCurrentTextIndex({
                                            "Typewriter.useEffect.handleTyping": (prev)=>prev + 1
                                        }["Typewriter.useEffect.handleTyping"]);
                                        setDisplayedText(''); // Clear for next text
                                    }
                                }["Typewriter.useEffect.handleTyping"], 1000); // Pause before typing next string
                            } else if (loop) {
                                timeoutId = setTimeout({
                                    "Typewriter.useEffect.handleTyping": ()=>setIsDeleting(true)
                                }["Typewriter.useEffect.handleTyping"], 2000); // Pause before deleting if looping
                            } else {
            ...
            if (!isTyping && inView) {
                ...
                }["Typewriter.useEffect.startTimeout"], delay);
                return ({
                    "Typewriter.useEffect": ()=>clearTimeout(startTimeout)
                })["Typewriter.useEffect"];
            }
            if (isTyping) {
                handleTyping();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('block min-h-[280px]', className),
        ...props,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('font-headline text-3xl font-bold tracking-tighter sm:text-4xl transition-opacity duration-300', currentTextIndex === 0 ? 'opacity-100' : 'opacity-0 max-h-0'),
                children: currentTextIndex === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('inline-block h-[2.2rem] w-[3px] ml-1 bg-primary align-bottom', isTyping ? 'animate-pulse' : 'opacity-0'),
                            style: {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('text-lg text-muted-foreground space-y-4 transition-opacity duration-300', currentTextIndex > 0 ? 'opacity-100' : 'opacity-0 max-h-0'),
                children: currentTextIndex > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "break-words",
                            children: textArray[1]
                        }, void 0, false, {
                            fileName: "[project]/src/components/ui/typewriter.tsx",
                            lineNumber: 132,
                            columnNumber: 13
...
*/ 
_s(Typewriter, "cL+oWFQcZf8hmQ7ZturkzIPN/DA=", false, function() {
    return [
...
//# sourceMappingURL=src_components_b898a8c2._.js.map