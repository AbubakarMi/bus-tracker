...
export default function StaffPage() {
  ...
  const upcomingTrips = [
    ...
    {
      id: 2,
      route: "Route 28 - Admin Building to Parking",
      time: "5:45 PM",
      status: "on-time",
      seat: "A3",
      driver: "Maria Garcia",
      estimatedArrival: "7 hrs 15 mins"
    }
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button asChild variant="outline" size="sm" className="gap-2">
            <Link href="/dashboard/staff/book">
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/dashboard/staff/book" className="gap-1 text-xs">
            ...
            {upcomingTrips.length > 0 ? (
                  ...
                  <div key={trip.id} className="p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      ...
                      <Button variant="outline" size="sm" asChild>
                        <Link href="/dashboard/staff/track" className="gap-1">
              ...
              <div className="text-center py-6">
                ...
                <Button asChild size="sm">
                  <Link href="/dashboard/staff/book">Book a Trip</Link>
                </Button>
              </div>
            )}
          </CardContent>
