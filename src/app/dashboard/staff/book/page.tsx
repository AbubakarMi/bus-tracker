...
const routes = [
  ...
  {
    id: 2,
    name: "Route 28 - Admin Building to Parking",
    from: "Admin Building",
    to: "Staff Parking",
    duration: "15 mins",
    price: 250,
    times: ["7:00 AM", "8:00 AM", "9:00 AM", "12:00 PM", "1:00 PM", "5:00 PM", "6:00 PM"],
    availability: { "7:00 AM": 6, "8:00 AM": 4, "9:00 AM": 10, "12:00 PM": 12, "1:00 PM": 8, "5:00 PM": 3, "6:00 PM": 9 }
  },
  {
    id: 3,
    name: "Route 35 - Faculty Housing Loop",
    from: "Faculty Housing",
    to: "Campus Loop",
    duration: "30 mins",
    price: 400,
    times: ["8:30 AM", "10:30 AM", "1:30 PM", "3:30 PM", "5:30 PM"],
    availability: { "8:30 AM": 7, "10:30 AM": 11, "1:30 PM": 14, "3:30 PM": 5, "5:30 PM": 8 }
  }
];
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button asChild className="flex-1">
                <a href="/dashboard/staff/track" className="flex items-center justify-center gap-2">
              ...
              <Button variant="outline" onClick={() => {
                ...
                setSelectedTime('');
                setPassengerInfo({ name: '', email: '', phone: '', staffId: '', department: '' });
              }}>
                Book Another Trip
              </Button>
            </div>
      ...
      {step === 3 && selectedRoute && selectedDate && selectedTime && (
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold font-headline">Staff Details</h1>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={passengerInfo.staffId}
                        onChange={(e) => setPassengerInfo(prev => ({ ...prev, staffId: e.target.value }))}
                        className="pl-10"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={passengerInfo.department}
                    onChange={(e) => setPassengerInfo(prev => ({ ...prev, department: e.target.value }))}
                  />
                </div>
