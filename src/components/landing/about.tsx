      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="relative order-last lg:order-first">
             <div className="absolute -left-4 -top-4 -bottom-4 w-2/3 rounded-lg bg-primary/10 lg:-bottom-8 lg:-left-8 card-pulse" />
            <div className="relative z-10 space-y-6 rounded-lg bg-card p-8 shadow-2xl lg:p-12 card-hover-zoom">
              <AnimatedText
                text={title}
                el="h2"
