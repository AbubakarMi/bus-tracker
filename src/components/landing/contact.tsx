...
const contactInfo = [
    ...
    { icon: <Phone className="h-6 w-6 text-primary-foreground" />, title: 'Call Us', value: '+234 123 456 7890' },
    { icon: <MapPin className="h-6 w-6 text-primary-foreground" />, title: 'Visit Us', value: 'Wudil, Kano State, Nigeria' },
];
